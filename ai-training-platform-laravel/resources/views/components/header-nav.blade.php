        ...
        <div class="flex items-center justify-between gap-spacing-lg">
            <div class="flex items-center gap-spacing-lg flex-1 min-w-0">
                ...
                <nav class="hidden md:flex items-center gap-spacing-sm lg:gap-spacing-md">
                    <a href="/" 
                       class="nav-link whitespace-nowrap {{ request()->is('/') ? 'active' : '' }}">
                        Home
                    </a>
                    <a href="/class-selection" 
                       class="nav-link whitespace-nowrap {{ request()->is('class-selection*') ? 'active' : '' }}">
                        Tracks
                    </a>
                    <a href="/developers" 
                       class="nav-link whitespace-nowrap {{ request()->is('developers*') ? 'active' : '' }}">
                        My Progress
                    </a>
                </nav>
            </div>
