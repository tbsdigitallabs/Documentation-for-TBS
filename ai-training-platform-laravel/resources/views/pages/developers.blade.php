        ...
        <x-container>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-spacing-lg">
                @foreach($modules as $module)
                    <x-holo-card role="developers" class="h-full flex flex-col hover:-translate-y-1 transition-transform">
                        <div class="flex items-center spacing-x-md mb-spacing-md">
                            ...
                            <div>
                                ...
                                <div class="text-small bg-accent-developers/10 px-2 py-1 rounded">{{ $module['badge'] }}</div>
                            </div>
                        </div>
                        ...
                        <div class="mb-spacing-md">
                            ...
                            <x-progress-bar value="{{ $module['progress'] }}" color="developers" show-label="false" />
                        </div>
                        <x-button href="/developers/module-{{ $module['number'] }}" variant="default" size="lg" class="w-full">
            ...
            <div class="mt-spacing-xl text-center">
                <x-button href="/class-selection" variant="outline" size="lg">
