...
Welcome back! Now that you've built some code, let's talk about testing it. If the word 'testing' makes you want to run away, don't worry—this module will change your mind.
...
![Testing Meme](https://media.giphy.com/media/12NUbkX6p4xOO4/giphy.gif)
...
![Testing Paradox](https://media.giphy.com/media/unQ3IJU2RG7DO/giphy.gif)
...
E2E tests check if your entire application works from a user's perspective—like clicking buttons and filling forms.
