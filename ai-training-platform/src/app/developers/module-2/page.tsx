        ...
        >
            <div className="space-y-6">
                <div className="bg-surface-card p-6 rounded-lg border border-border-primary">
                    <h2 className="text-xl font-semibold text-content-primary mb-4">Quest 1: GitHub Copilot Setup</h2>
                ...
                <div className="bg-surface-card p-6 rounded-lg border border-border-primary opacity-75">
                    <h2 className="text-xl font-semibold text-content-tertiary mb-4">Quest 2: Effective Prompting for Code</h2>
                ...
                <div className="bg-surface-card p-6 rounded-lg border border-border-primary opacity-75">
                    <h2 className="text-xl font-semibold text-content-tertiary mb-4">Quest 3: Code Review with Copilot</h2>
                    <p className="text-content-tertiary mb-4">
                ...
                <div className="bg-surface-card p-6 rounded-lg border border-border-primary opacity-75">
                    <h2 className="text-xl font-semibold text-content-tertiary mb-4">Quest 4: Advanced Copilot Techniques</h2>
                    <p className="text-content-tertiary mb-4">
