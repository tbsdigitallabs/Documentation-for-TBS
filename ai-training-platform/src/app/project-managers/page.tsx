...
export default function ProjectManagersPage() {
  ...
  const isUserClass = userClass === "Paladin";
          ...
          <div className="text-center mb-16">
            ...
            {!isUserClass && userClass && (
              <p className="text-content-tertiary text-sm mb-4">
                You're exploring the Paladin class. Your primary class is {getClassDisplayName(userClass)}.
              </p>
            )}
      ...
      <Section className="bg-gradient-surface py-16" size="lg">
        <Container size="xl">
          <h2 className="text-2xl font-heading font-bold text-content-primary mb-6">
            {isUserClass ? "Your Adventures" : "Paladin Adventures"}
          </h2>
