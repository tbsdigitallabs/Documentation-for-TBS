      ...
      <Section className="bg-surface-hero py-8 pt-24" size="md">
        <Container size="lg">
          <div className="text-center mb-8">
            <p className="mono-label text-accent-readable-sage mb-2">OPTIONAL TOOLS</p>
            <div className="inline-flex items-center justify-center p-3 mb-4 rounded-full bg-accent-sage-5 border border-accent-sage-20 shadow-lg">
              <Wrench className="w-8 h-8 text-accent-sage-500" />
            </div>
            ...
            <p className="text-content-secondary max-w-2xl mx-auto text-lg leading-relaxed">
              Learn best practices and standard operating procedures for specific AI tools. These modules are optional and can be completed at any time.
            </p>
          </div>
        </Container>
      </Section>
        ...
        <Container size="xl">
          {modules.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
              {modules.map((module) => (
                <HoloCard key={module.slug} className="flex flex-col h-full">
                  <div className="mb-6">
                    <span className="mono-label text-accent-sage-500 px-2 py-1 rounded-md bg-accent-sage-5 border border-accent-sage-20 inline-block">
                      TOOL {module.slug.split('-')[0].padStart(2, '0')}
                    </span>
                  </div>
                  ...
                  <Link href={`/tools/${module.slug}`} className="mt-auto">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-content-tertiary">Tool modules coming soon.</p>
            </div>
          )}
